package com.jona.instalikeviewer.adaptors;
...
import com.jona.instalikeviewer.helpers.Utility;
...
public class InstaLikePhotosAdaptor extends ArrayAdapter<InstaLikePhoto> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			viewHolder.tvTimeCreated.setText(Utility.getTimePostedShort(photo.timeCreated));
